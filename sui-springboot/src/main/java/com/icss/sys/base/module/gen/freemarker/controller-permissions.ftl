...
import com.admin.sys.extend.web.BaseAction;
...
public class ${className}Controller extends BaseAction {
    ...
    */
    ...
    @RequiresPermissions("${className?uncap_first}:getPage")
    ...
    */
    @RequestMapping("/get")
    @RequiresPermissions(value = {"${className?uncap_first}:edit","${className?uncap_first}:view"},logical = Logical.OR)
    ...
    */
    @RequestMapping("/sub")
    @RequiresPermissions("${className?uncap_first}:save")
...
<#if isPort=='true'>
    ...
    */
    ...
    @RequiresPermissions("${className?uncap_first}:import")
