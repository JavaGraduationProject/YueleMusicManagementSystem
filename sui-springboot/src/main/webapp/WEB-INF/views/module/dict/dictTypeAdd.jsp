...
<form class="layui-form layui-form-pane" role="form" action="" method="post">
    ...
    <input type="hidden" name="type" value="dict" class="layui-input">
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="requireField">*</span>字典名称</label>
        <div class="layui-input-block">
            <input type="text" autocomplete="off" lay-verify="required|labelUnique" name="label"
                   value="${sysDict.label}" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="requireField">*</span>字典编码</label>
        <div class="layui-input-block">
            <input type="text" autocomplete="off" lay-verify="required|valueUnique|validFieldCode" name="value"
                   value="${sysDict.value}" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="requireField">*</span>排序</label>
        <div class="layui-input-block">
            <input type="number" autocomplete="off" lay-verify="required|number" name="sort" value="${sysDict.sort}"
                   class="layui-input">
        </div>
    </div>
</form>
    ...
    layui.use(['jquery', 'form', 'laydate', 'layer', 'laytpl', 'element'], function () {
        ...
        form.verify({
            labelUnique: function (value) {
                ...
                var params = {"label": value, "type": "dict"};
            ...
            valueUnique: function (value) {
                var id = "${sysDict.id}";
                var tableName = "sys_dict";
                var params = {"value": value, "type": "dict"};
                var validResult = validForm.validFieldUnique(params, tableName, id);
                return validResult;
            },
